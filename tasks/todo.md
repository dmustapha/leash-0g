...
- [ ] **BLOCKED — run it (needs Dami):** (1) Render backend redeployed on the Phase-4 branch, (2) Render env `LEASH_FACTORY_ADDR`=v3 `0xcD78…8105` + TestUSD `0xbeeA…4e52`, (3) phone tap on the Telegram APPROVE card. Script never approves — the phone does.
